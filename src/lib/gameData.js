...
export const CROPS = {
  // v2 — EXP nerfed, level req raised, progression slower & more meaningful
  wheat:      { id:0, name:"Wheat",      emoji:"🌾", unlockLevel:1, seedCost:10,  sellPrice:12,  growTime:15,  eP:8,  eW:5,  eH:5,  exp:3,   color:"#c8a800", stages:["🌱","🌿","🌾"] },
  carrot:     { id:1, name:"Carrot",     emoji:"🥕", unlockLevel:1, seedCost:18,  sellPrice:22,  growTime:25,  eP:12, eW:8,  eH:8,  exp:6,   color:"#e06020", stages:["🌱","🌿","🥕"] },
  corn:       { id:2, name:"Corn",       emoji:"🌽", unlockLevel:2, seedCost:30,  sellPrice:38,  growTime:45,  eP:18, eW:12, eH:12, exp:14,  color:"#e0b800", stages:["🌱","🌿","🌽"] },
  tomato:     { id:3, name:"Tomato",     emoji:"🍅", unlockLevel:3, seedCost:25,  sellPrice:32,  growTime:35,  eP:15, eW:10, eH:10, exp:11,  color:"#d83040", stages:["🌱","🌿","🍅"] },
  pumpkin:    { id:4, name:"Pumpkin",    emoji:"🎃", unlockLevel:4, seedCost:50,  sellPrice:65,  growTime:70,  eP:25, eW:18, eH:18, exp:28,  color:"#d86820", stages:["🌱","🌿","🎃"] },
  strawberry: { id:5, name:"Strawberry", emoji:"🍓", unlockLevel:5, seedCost:65,  sellPrice:85,  growTime:90,  eP:32, eW:22, eH:22, exp:42,  color:"#e03050", stages:["🌱","🌿","🍓"] },
  blueberry:  { id:6, name:"Blueberry",  emoji:"🫐", unlockLevel:7, seedCost:110, sellPrice:148, growTime:150, eP:50, eW:35, eH:35, exp:75,  color:"#5060d0", stages:["🌱","🌿","🫐"] },
  goldenroot: { id:7, name:"GoldenRoot", emoji:"✨", unlockLevel:9, seedCost:220, sellPrice:300, growTime:300, eP:95, eW:65, eH:65, exp:160, color:"#f0c030", stages:["🌱","🌿","✨"] },
};
